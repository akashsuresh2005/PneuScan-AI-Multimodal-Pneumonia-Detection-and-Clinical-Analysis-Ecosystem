  ...
  <style>{`
    ...
    *, *::before, *::after {
    ...
    @media (max-width: 960px) {
      ...
      .left-panel, .right-panel { width: 100% !important; height: auto; overflow-y: visible; position: static; }
      .right-panel { min-height: 60vh; }
      .scan-canvas { height: 280px; }
      .metric-divider { display: none; }
    }
    ...
    @media (max-width: 420px) {
      ...
      .role-card { padding: 9px 10px; }
      .role-label { font-size: 13px; }
      .metrics-row { gap: 6px; }
      .metric-pill { padding: 7px 10px; }
      .metric-pill-val { font-size: 12px; }
      .image-grid-section > div[style] { grid-template-columns: 1fr !important; }
      .scan-canvas { height: 200px; }
      .secondary-imgs { grid-template-columns: 1fr; }
      .right-footer { flex-direction: column; align-items: flex-start; }
    }
  `}</style>
);
